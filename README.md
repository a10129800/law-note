...
- **🎨 案例導航控制台高彩度存在感重構**：
  - 拒絕死白淡色，配置 **8px 實心側邊色軸**（翡翠綠 `#047857`、皇家�   * [`content/view-part0-ch2-sec1.js`](file:///c:/Users/mice/.gemini/antigravity-ide/scratch/criminal-law-notes/content/view-part0-ch2-sec1.js)（第一節 刑法的適用效力：教材第 2-9 ～ 2-14 頁全節完結，涵蓋時之效力、繼續犯、限時法76決議、保安處分雙軌制、屬地原則三大支柱、輔助基準三大原則、案例 2-1 ～ 2-6、72台上5872號判例、廣大興案實例剖析、外國裁判複動原則 § 9、【表 1】思考順序決策樹、人的適用效力總統刑事豁免權、民代言論免責權、外交豁免權與訴訟障礙事由 vs 實體免責權本質解題提示）
* **控制器層 (`js/`)**：
...
- **教材第 2-9 ～ 2-14 頁原文忠實收錄 (`content/view-part0-ch2-sec1.js`)**：
  ...
  - **案例 2-1 拘禁跨越修法案**：私行拘禁罪（§ 302）為繼續犯（Dauerdelikt），犯罪行為終了在破案時，適用新法為行為時法，根本不生從舊從輕比較問題。
  - **案例 2-2 限時法之追溯效力案**：最高法院 76 年第 12 次刑庭決議（肯定說諭知免訴）。
  - 保安處分時間效力雙軌制：拘束人身自由（從舊從輕 § 2 Ⅰ） vs 非拘束人身自由（裁判時法 § 2 Ⅱ）。
  - 地的適用效力三大支柱：核心（領土領海領空）、擴張（浮動領土 § 3 但書）、隔地犯（行為或結果地擇一 § 4）。
  - **案例 2-3 跨境電信詐騙案**（隔地犯結果地管轄）、**案例 2-4 駐外使領館犯罪案**（國際法管轄放棄慣例）、**案例 2-5 大陸地區犯罪案**（90台上4247特殊國內關係）。
  - 輔助基準三大原則（屬人 § 6+§ 7、保護 § 5+§ 8、世界 § 5 各款）與 **案例 2-6 境外偽造外國股票案**（72台上5872判例：保護原則限本國法益）。
  - **廣大興案實例剖析**：公海開槍射殺我國船長，主要基準（§ 3 但書浮動領土＋§ 4 隔地犯結果地）優先於保護原則（§ 8），避免跳躍思考；許恆達教授論文引用。
  - **外國裁判之效力 ➔ 複動原則（刑法 § 9）**：主權獨立不生一事不再理，外國已受刑得免其刑執行折抵人權保障。
  - **【表 1】地的適用效力思考順序流程圖**（主要基準 § 3+§ 4 ➔ 國外犯罪輔助基準 § 5 ➔ § 6 ➔ § 7 ➔ § 8 ➔ 不適用）。
  - **三、人的適用效力**：
    - (一) 總統 ➔ 刑事豁免權（憲法 § 52、釋字第 627 號：限縮性、暫時性訴訟障礙事由）。
    - (二) 民代 ➔ 言論免責權（憲法 § 73、釋字第 165、435 號：實體自始排除刑罰事由，蓄意肢體暴力除外）。
    - (三) 外國元首、大使、領事、使節、駐軍 ➔ 外交豁免權。
  - **📖 解題提示**：總統刑事豁免權（程序法訴訟障礙事由）vs. 民代言論免責權（實體法免責權）本質區辨對照表。
  - 2026 現行法規與憲法裁判查核：113年憲判字第9號立法院職權與言論免責界限。
- **全套三層階層樹導航完備**：
  - 第二章下方建立專屬子目錄容器 `#part0Ch2SubTree`，配置 `navBtnPart0Ch2Sec1`（第一節 刑法的適用效力）。
  - 第二章主視圖內 Section 1 卡片即時亮起 `READY TO READ` 標章，提供直接進入按鈕。
  - `TOC_CONFIG`、`SEARCH_DATABASE` 與 `js/app.js` 完整登錄子節與案例 2-1～2-6、廣大興案、釋字 627/435，支援 `Ctrl+K` 快速搜尋秒級跳轉。③確認利益保障說（學說有力說 ⭐）。
...
* **視圖層 (`content/`)**：
  ...
  * [`content/view-part0-ch2-sec1.js`](file:///c:/Users/mice/.gemini/antigravity-ide/scratch/criminal-law-notes/content/view-part0-ch2-sec1.js)（第一節 刑法的適用效力：教材第 2-9 ～ 2-12 頁全節完結，涵蓋時之效力、繼續犯、限時法76決議、保安處分雙軌制、屬地原則三大支柱、輔助基準三大原則、案例 2-1 ～ 2-6、72台上5872號判例與審查順序解題提示）
* **控制器層 (`js/`)**：
  * [`js/app.js`](file:///c:/Users/mice/.gemini/antigravity-ide/scratch/criminal-law-notes/js/app.js)（視圖自動注入、深淺主題、Aa 字級與行距、Hash 路由、Scrollspy、全域搜尋、法條懸浮、案例複製、架構圖燈箱）
