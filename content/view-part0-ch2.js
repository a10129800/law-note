        ...
        <div id="viewPart0Chapter2" class="fade-enter hidden space-y-8">
          ...
          <section id="sec-p0ch2-upcoming-sections" class="space-y-6 pt-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <!-- 預備單元卡片 2 -->
              <div class="p-5 rounded-2xl border border-purple-500/30 hover:border-purple-500/60 bg-gradient-to-br from-purple-50/40 to-slate-50/40 dark:from-purple-950/20 dark:to-slate-900/40 shadow-sm space-y-3 relative overflow-hidden group transition-all flex flex-col justify-between">
                <div class="space-y-3">
                  <div class="flex items-center justify-between">
